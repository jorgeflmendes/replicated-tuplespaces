...
public class PutBackendResponseCollector {
    ArrayList<PutBackendResponse> collectedResponses;
    private final ArrayList<StatusRuntimeException> errors;

    public PutBackendResponseCollector() {
        collectedResponses = new ArrayList<PutBackendResponse>();
        errors = new ArrayList<>();
    }

    synchronized public void addResponse(PutBackendResponse response) {
        collectedResponses.add(response);
        notifyAll();
    }

    synchronized public ArrayList<PutBackendResponse> getResponses() {
